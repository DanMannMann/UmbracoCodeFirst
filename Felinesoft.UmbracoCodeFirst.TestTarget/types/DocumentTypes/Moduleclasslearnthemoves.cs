...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Moduleclasslearnthemoves : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.BlackOrWhite Ltmplaybuttoncolour { get; set; }

            [ContentProperty(@"Background Colour", @"LTMHerobackgroundColour", false, @"", 9, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Ltmherobackgroundcolour { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleMediaPicker Ltmrelatedvidoes { get; set; }

            [ContentProperty(@"Video Header Colour", @"LTMVideoHeaderColour", false, @"", 6, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Ltmvideoheadercolour { get; set; }

            [ContentProperty(@"Video Subheader Colour", @"LTMVideoSubheaderColour", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Ltmvideosubheadercolour { get; set; }

            [ContentProperty(@"HeadingColour", @"headingcolour", false, @"", 1, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Headingcolour { get; set; }

            [ContentProperty(@"Subheading Colour", @"subheadingColour", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Subheadingcolour { get; set; }

            [ContentProperty(@"Related Video Background Colour", @"relatedVideoBackgroundColour", false, @"", 14, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Relatedvideobackgroundcolour { get; set; }
