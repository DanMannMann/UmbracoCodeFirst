...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Seopage : Master
    {
        public class SEOTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.ChangeFrequency Changefrequency { get; set; }

            [ContentProperty(@"Canonical URL", @"canonicalUrl", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Canonicalurl { get; set; }
        ...
        public class ReferencesTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleTextBox Pagereferences { get; set; }

        }
        public class OpenGraphTab : TabBase
        {
            [ContentProperty(@"Open Graph Tags", @"openGraphTags", false, @"", 0, false)]
            public UmbracoCodeFirst.GeneratedTypes.Union_Opengraphtags Opengraphtags { get; set; }
        ...
        public class OnDemandTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.NavOverridePicker Navoverride1 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.NavOverridePicker Navoverride2 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.NavOverridePicker Navoverride3 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Navoverride1link { get; set; }

            [ContentProperty(@"Nav Override 2 Link", @"navOverride2Link", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Navoverride2link { get; set; }

            [ContentProperty(@"Nav Override 3 Link", @"navOverride3Link", false, @"", 11, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Navoverride3link { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Sublinksforthispage { get; set; }
