...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Settings : Master
    {
        public class ConfigTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.Topics Topics { get; set; }
        ...
        public class FooterTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Footercategory1links { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Footercategory2links { get; set; }

            [ContentProperty(@"Footer Category 2 Links 2", @"footerCategory2Links2", false, @"", 7, false)]
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Footercategory2links2 { get; set; }

            [ContentProperty(@"Footer Category 2 Links 3", @"footerCategory2Links3", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Footercategory2links3 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleURLPicker Secondarylinks { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Footeryellowcustomlinkurl { get; set; }
        ...
        public class FindAClassTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Findaclasssubtitlelink { get; set; }
