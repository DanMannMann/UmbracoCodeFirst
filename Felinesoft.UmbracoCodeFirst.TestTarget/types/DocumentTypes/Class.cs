...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Class : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Classprogrammecolour { get; set; }

        }
        public class GridTab : TabBase
        {
            [ContentProperty(@"Class Body Colour", @"classBodyColour", false, @"", 0, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Classbodycolour { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Classtitlecolour { get; set; }

            [ContentProperty(@"Class background colour", @"classBackgroundColour", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Classbackgroundcolour { get; set; }
        ...
        public class ClassListTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Classlinkarrow { get; set; }

        }
        public class ConfigTab : TabBase
        {
            [ContentProperty(@"CSS Class Names", @"cssClassNames", true, @"", 1, false)]
            public UmbracoCodeFirst.GeneratedTypes.MultipleTextBox Cssclassnames { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Cssbackgroundcolour { get; set; }

            [ContentProperty(@"CSS Foreground Colour", @"cssForegroundColour", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Cssforegroundcolour { get; set; }
