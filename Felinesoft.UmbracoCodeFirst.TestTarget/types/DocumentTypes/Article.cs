...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Article : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.TopicSelector_Limit_4_ Topics { get; set; }
        ...
        public class MoreNewsTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.ArticlePicker Morenewsarticle1 { get; set; }

            [ContentProperty(@"More News Article 2", @"moreNewsArticle2", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.ArticlePicker Morenewsarticle2 { get; set; }

            [ContentProperty(@"More News Article 3", @"moreNewsArticle3", false, @"", 4, false)]
            public UmbracoCodeFirst.GeneratedTypes.ArticlePicker Morenewsarticle3 { get; set; }

            [ContentProperty(@"More News Article 4", @"moreNewsArticle4", false, @"", 5, false)]
            public UmbracoCodeFirst.GeneratedTypes.ArticlePicker Morenewsarticle4 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Morenewsctaurl { get; set; }
