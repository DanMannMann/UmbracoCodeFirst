...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Moduletestimonial : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.TestimonialsPicker Testimonial1 { get; set; }

            [ContentProperty(@"Testimonial 2", @"testimonial2", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.TestimonialsPicker Testimonial2 { get; set; }

            [ContentProperty(@"Testimonial 3", @"testimonial3", false, @"", 4, false)]
            public UmbracoCodeFirst.GeneratedTypes.TestimonialsPicker Testimonial3 { get; set; }

            [ContentProperty(@"Testimonial 4", @"testimonial4", false, @"", 5, false)]
            public UmbracoCodeFirst.GeneratedTypes.TestimonialsPicker Testimonial4 { get; set; }

            [ContentProperty(@"Testimonial 5", @"testimonial5", false, @"", 6, false)]
            public UmbracoCodeFirst.GeneratedTypes.TestimonialsPicker Testimonial5 { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Leavetestimonialbackgroundcolour { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Leavetestimonialbuttonurl { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Moretestimonialsctaurl { get; set; }
