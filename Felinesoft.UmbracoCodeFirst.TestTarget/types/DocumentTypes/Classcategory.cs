...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Classcategory : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Menutitlecolour { get; set; }

            [ContentProperty(@"Menu Background Colour", @"menuBackgroundColour", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Menubackgroundcolour { get; set; }

            [ContentProperty(@"Page Description Heading Colour", @"pageDescriptionHeadingColour", false, @"", 6, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Pagedescriptionheadingcolour { get; set; }

            [ContentProperty(@"Page Description Body Colour", @"pageDescriptionBodyColour", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Pagedescriptionbodycolour { get; set; }

            [ContentProperty(@"Page Description Background Colour", @"pageDescriptionBackgroundColour", false, @"", 9, false)]
            public UmbracoCodeFirst.GeneratedTypes.ColourPicker Pagedescriptionbackgroundcolour { get; set; }
