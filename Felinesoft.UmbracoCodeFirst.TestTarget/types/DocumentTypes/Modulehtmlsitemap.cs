...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Modulehtmlsitemap : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Ctalink { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.MultipleNodeHTMLSitemapPicker Sitemapsections { get; set; }
