...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Eventlisting : Seopage
    {
        ...
        public class GridTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.EventPicker Event1 { get; set; }

            [ContentProperty(@"Event 2", @"event2", false, @"", 1, false)]
            public UmbracoCodeFirst.GeneratedTypes.EventPicker Event2 { get; set; }

            [ContentProperty(@"Event 3", @"event3", false, @"", 2, false)]
            public UmbracoCodeFirst.GeneratedTypes.EventPicker Event3 { get; set; }

            [ContentProperty(@"Event 4", @"event4", false, @"", 3, false)]
            public UmbracoCodeFirst.GeneratedTypes.EventPicker Event4 { get; set; }

            [ContentProperty(@"Event 5", @"event5", false, @"", 4, false)]
            public UmbracoCodeFirst.GeneratedTypes.EventPicker Event5 { get; set; }
