...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Modulesupporting : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.SmallRichText Footertitle { get; set; }
            ...
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Moduleheadingcolour { get; set; }
