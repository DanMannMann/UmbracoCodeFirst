...
namespace UmbracoCodeFirst.GeneratedTypes
{
    ...
    public class Modulegear : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Gearbackgroundcolour { get; set; }

            [ContentProperty(@"Module Subheading Colour", @"moduleSubheadingColour", false, @"", 2, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Modulesubheadingcolour { get; set; }

            [ContentProperty(@"Module Heading Colour", @"gearModuleHeadingColour", false, @"", 8, false)]
            public UmbracoCodeFirst.GeneratedTypes.SpectrumColorPicker Gearmoduleheadingcolour { get; set; }
        ...
        public class GalleryTab : TabBase
        {
            ...
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl1 { get; set; }

            [ContentProperty(@"CTA 2 Url", @"gearCtaUrl2", false, @"", 7, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl2 { get; set; }

            [ContentProperty(@"CTA 3 Url", @"gearCtaUrl3", false, @"", 11, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl3 { get; set; }

            [ContentProperty(@"CTA 4 Url", @"gearCtaUrl4", false, @"", 15, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl4 { get; set; }

            [ContentProperty(@"CTA 5 Url", @"gearCtaUrl5", false, @"", 19, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl5 { get; set; }

            [ContentProperty(@"CTA 6 Url", @"gearCtaUrl6", false, @"", 23, false)]
            public UmbracoCodeFirst.GeneratedTypes.UrlPicker Gearctaurl6 { get; set; }
