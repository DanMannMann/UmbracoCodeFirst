    ...
    public class TypeSet3Tests : TestBase, ICodeFirstTest
    {
        ...
        private List<ExpectedType> GetDocTypes()
        {
            ...
            result.Add(new ExpectedType()
            {
                ...
                Name = "Master Renamed",
                AllowAtRoot = true,
                AllowedChildrenAliases = new string[] { "child1", "child2", "grandChild1" },
                CompositionAliases = new string[] { },
                Description = string.Empty,
                IconWithColor = "icon-document color-blue",
                ListView = false,
            ...
            tabs.Add(new ExpectedTab()
            {
                Name = "Composition Tab",
                SortOrder = 0,
                Properties = NewList<ExpectedProperty>(new ExpectedProperty()
                {
                    Name = "Composition Tab Picker",
                    Alias = "compositionTabPicker",
                    Description = string.Empty,
                    Mandatory = false,
                    Regex = string.Empty,
                    SortOrder = 0,
        ...
        private List<X> NewList<X>(params X[] input)
        {
            return new List<X>(input);
        }
        ...
        private List<ExpectedType> GetMediaTypes()
        {
            ...
            AddProperties(result.Last(), "mediaMaster", "Media Master", 2);
            AddTab(result.Last(), "master", "Master", false, 3);
            ...
            result.Add(new ExpectedType()
            {
                ...
                AllowAtRoot = false,
                AllowedChildrenAliases = new string[] { },
                CompositionAliases = new string[] { "mediaComposition", "mediaChild2Composition" },
                Description = string.Empty,
                IconWithColor = "icon-document",
                ListView = false,
                ParentAlias = "mediaMaster",
        ...
        private void AddProperties(ExpectedType expectedType, string alias, string name, int count = 3)
        {
            ...
            {
                Name = alias == "master" ? "Master Textstring Renamed Root" : name + " Textstring Root",
