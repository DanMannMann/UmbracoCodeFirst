...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Moduleclasseshero : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Herofooterbackgroundcolour { get; set; }

            [ContentProperty(@"Footer Item Background Colour", @"heroFooterItemBackgroundColour", false, @"", 6, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Herofooteritembackgroundcolour { get; set; }

            [ContentProperty(@"Button Url", @"heroButtonUrl", true, @"", 7, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Herobuttonurl { get; set; }

            [ContentProperty(@"CTA 1 Url", @"heroCTA1Url", false, @"", 13, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Herocta1url { get; set; }

            [ContentProperty(@"CTA 2 Url", @"heroCTA2Url", false, @"", 16, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Herocta2url { get; set; }

            [ContentProperty(@"Hero Heading Colour", @"heroHeadingColour", true, @"", 1, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Heroheadingcolour { get; set; }

            [ContentProperty(@"Hero Subheading Colour", @"heroSubheadingColour", false, @"", 3, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Herosubheadingcolour { get; set; }
