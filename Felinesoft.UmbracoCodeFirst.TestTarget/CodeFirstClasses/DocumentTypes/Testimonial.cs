...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Testimonial : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Testimonialctalink { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.ColourPicker Testimonialbackgroundcolour { get; set; }
