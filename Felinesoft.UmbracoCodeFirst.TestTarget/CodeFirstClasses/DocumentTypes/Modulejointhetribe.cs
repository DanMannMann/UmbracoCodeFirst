...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Modulejointhetribe : Modules
    {
        public class SocialBlockTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.SocialMediaPicker Socialmediaservice { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box2 Imagelabelbox2 { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Facebookurl { get; set; }

        }
        public class SingleBigBlockTab : TabBase
        {
            [ContentProperty(@"Type", @"bigBlockType", false, @"", 1, false)]
            public LMI.BusinessLogic.CodeFirst.ArticlePromoPicker Bigblocktype { get; set; }

            [ContentProperty(@"Article", @"bigBlockArticle", false, @"", 2, false)]
            public LMI.BusinessLogic.CodeFirst.ArticlePicker Bigblockarticle { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Bigblockpromourl { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box3 Imagelabelbox3 { get; set; }

            [ContentProperty(@"Background Colour", @"singleBigBlockBackgroundColour", false, @"", 5, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Singlebigblockbackgroundcolour { get; set; }
        ...
        public class StatsPromoBlocksTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Statblockbgcolour1 { get; set; }

            [ContentProperty(@"Background Color", @"statBlockBGColour2", false, @"", 7, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Statblockbgcolour2 { get; set; }

            [ContentProperty(@"Background Color", @"statBlockBGColour3", false, @"", 11, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Statblockbgcolour3 { get; set; }

            [ContentProperty(@"Background Color", @"statBlockBGColour4", false, @"", 15, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Statblockbgcolour4 { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box4 Imagelabelbox4 { get; set; }

            [ContentProperty(@"Stats Block 2", @"imageLabelBox5", false, @"", 4, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box5 Imagelabelbox5 { get; set; }

            [ContentProperty(@"Stats Block 4", @"imageLabelBox8", false, @"", 12, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box8 Imagelabelbox8 { get; set; }

            [ContentProperty(@"Stats Block 4", @"imageLabelBox7", false, @"", 8, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box7 Imagelabelbox7 { get; set; }
        ...
        public class ArticlePromoBlocksTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.BlackOrWhite Articletextcolour1 { get; set; }

            [ContentProperty(@"Background Color", @"articleBackgroundColour1", false, @"", 3, false)]
            public LMI.BusinessLogic.CodeFirst.ColourPicker Articlebackgroundcolour1 { get; set; }

            [ContentProperty(@"Article Block 1", @"articleBlock1", false, @"", 0, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box1 Articleblock1 { get; set; }

            [ContentProperty(@"Article Block 2", @"articleBlock2", false, @"", 4, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box6 Articleblock2 { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.BlackOrWhite Articletextcolour2 { get; set; }

            [ContentProperty(@"Background Color", @"articleBackgroundColour2", false, @"", 7, false)]
            public LMI.BusinessLogic.CodeFirst.ColourPicker Articlebackgroundcolour2 { get; set; }

            [ContentProperty(@"Article Block 3", @"articleBlock3", false, @"", 8, false)]
            public LMI.BusinessLogic.CodeFirst.JoinTheTribe_Box9 Articleblock3 { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.BlackOrWhite Articletextcolour3 { get; set; }

            [ContentProperty(@"Background Color", @"articleBackgroundColour3", false, @"", 11, false)]
            public LMI.BusinessLogic.CodeFirst.ColourPicker Articlebackgroundcolour3 { get; set; }
