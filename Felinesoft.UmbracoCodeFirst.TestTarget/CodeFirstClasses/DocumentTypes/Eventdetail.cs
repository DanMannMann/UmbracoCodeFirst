...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Eventdetail : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.ScheduleWizardExpress2014 Schedule { get; set; }

            [ContentProperty(@"Location", @"location", false, @"", 14, false)]
            public LMI.BusinessLogic.CodeFirst.GoogleMap Location { get; set; }

            [ContentProperty(@"Types", @"types", false, @"", 13, false)]
            public LMI.BusinessLogic.CodeFirst.EventTypePicker Types { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.ClassPicker Program { get; set; }
        ...
        public class MoreEventsTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.EventPicker Moreeventsevent1 { get; set; }

            [ContentProperty(@"Event 2", @"moreEventsEvent2", false, @"", 2, false)]
            public LMI.BusinessLogic.CodeFirst.EventPicker Moreeventsevent2 { get; set; }

            [ContentProperty(@"Event URL 1", @"eventUrl1", false, @"", 3, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Eventurl1 { get; set; }

            [ContentProperty(@"Event URL 2", @"eventUrl2", false, @"", 4, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Eventurl2 { get; set; }
        ...
        public class RegistrationTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Registrationlinkinstructor { get; set; }

            [ContentProperty(@"Registration link none Instructor", @"registrationLinkNoneInstructor", false, @"", 4, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Registrationlinknoneinstructor { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Registrationinfoctaurl { get; set; }
