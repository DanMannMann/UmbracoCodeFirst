...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Classeslanding : Seopage
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.ColourPicker Classherobackgroundcolour { get; set; }

            [ContentProperty(@"ClassHeroTitleColour", @"classHeroTitleColour", false, @"", 1, false)]
            public LMI.BusinessLogic.CodeFirst.ColourPicker Classherotitlecolour { get; set; }

            [ContentProperty(@"Class Hero Sub-Title Colour", @"classHeroSubTitleColour", false, @"Default to white", 3, false)]
            public LMI.BusinessLogic.CodeFirst.ColourPicker Classherosubtitlecolour { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Footerurl { get; set; }
