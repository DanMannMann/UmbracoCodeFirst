...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Moduleshop : Modules
    {
        ...
        public class LargePromoTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.ColourPicker Largepromobackgroundcolour { get; set; }

            [ContentProperty(@"Button Url", @"largePromoAreaButtonUrl", false, @"", 5, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Largepromoareabuttonurl { get; set; }
        ...
        public class SmallPromoTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.ColourPicker Smallpromobackgroundcolour { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Smallpromoareabuttonurl { get; set; }
