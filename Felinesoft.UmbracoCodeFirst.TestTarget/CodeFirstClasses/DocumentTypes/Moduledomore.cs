...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Moduledomore : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Domoremoduleheadingcolour { get; set; }

            [ContentProperty(@"Module subheading Colour", @"doMoreModuleSubheadingColour", false, @"", 3, false)]
            public LMI.BusinessLogic.CodeFirst.SpectrumColorPicker Domoremodulesubheadingcolour { get; set; }
        ...
        public class Item1Tab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Domoreurl1 { get; set; }
        ...
        public class Item2Tab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Domoreurl2 { get; set; }
        ...
        public class Item3Tab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Domoreurl3 { get; set; }
        ...
        public class Item4Tab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Domoreurl4 { get; set; }
