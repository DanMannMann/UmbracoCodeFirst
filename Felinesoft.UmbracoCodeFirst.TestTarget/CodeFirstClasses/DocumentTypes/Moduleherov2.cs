...
namespace LMI.BusinessLogic.CodeFirst
{
    ...
    public class Moduleherov2 : Modules
    {
        public class ContentTab : TabBase
        {
            ...
            public LMI.BusinessLogic.CodeFirst.UrlPicker Cta1url { get; set; }

            [ContentProperty(@"CTA 2 Url", @"cta2Url", false, @"", 5, false)]
            public LMI.BusinessLogic.CodeFirst.UrlPicker Cta2url { get; set; }
            ...
            public LMI.BusinessLogic.CodeFirst.VideoPicker Video { get; set; }
