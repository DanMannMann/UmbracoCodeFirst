...
namespace Felinesoft.UmbracoCodeFirst
{
    ...
    //        {
    //            if (!CodeFirstManager.Current.Modules.DataTypeModule.DataTypeRegister.IsRegistered(type))
    //            {
    //                throw new CodeFirstException(type.Name + " is not registered. Cannot get prevalues.");
    //            }

    //            var reg = CodeFirstManager.Current.Modules.DataTypeModule.DataTypeRegister.GetRegistration(type);
